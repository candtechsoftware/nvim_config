...
-- background. Identical to naysayer.lua except the background family (editor,
-- floats, gutter, cursorline) drops the dark teal for grey, and the
-- background-tinted greys (NonText/indent guides, diff washes) are pulled
-- down to match. Every foreground hue is unchanged.
...
vim.g.colors_name = "naysayer_black"
...
local c = {
  ...
  line_bg  = "#1a1a1a", -- gutter background (same as editor in naysayer)
...
local links = {
  ...
  ["@lsp.typemod.property.inactive"] = "@variable",
  ["@lsp.typemod.variable.inactive"] = "@variable",
...
hl(0, "DiffAdd",    { bg = "#17301d" })
hl(0, "DiffChange", { bg = "#162834" })
hl(0, "DiffDelete", { fg = c.error, bg = "#33141a" })
hl(0, "DiffText",   { bg = "#1b3d57", bold = true })
