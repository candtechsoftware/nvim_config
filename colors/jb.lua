...
local colors = {
    -- Core backgrounds - using scope color as main bg
    background0 = "#00000000",
    background1 = "#10101010",
    background2 = "#1e1e1e1e",
    background3 = "#1e1e1e1e",
    background4 = "#1e1e1e1e",
    ...
    scrollbar = "#12636719",
    scrollbar_hover = "#1263674C",
    scrollbar_background = "#0b33354C",
    cursor = "#FFFFFFFF",
    cursor_inactive = "#126367FF",
    paste_animation = "#2ec09c4C",
    splitter = "#0b3335FF",
    splitter_hover = "#0e3a3cFF",
    letter_highlight = "#FFFFFFFF",
    list_cursor_lite = "#2ec09c19",
    list_cursor = "#2ec09c4C",
    shadow_dark = "#0b333533",
    shadow_transparent = "#0b333500",
    text_input_label = "#126367FF",
    ui_default = "#d1b897FF",
    ui_dim = "#126367FF",
    ui_neutral = "#4C4C4CFF",
    ui_warning = "#ffaa00FF",
    ...
    region_header = "#0e3a3cFF",
    region_success = "#226022FF",
    region_warning = "#986032FF",
    region_error = "#772222FF",
    region_heredoc = "#041a1dFF",
    build_panel_background = "#0b3335FF",
    build_panel_scrollbar = "#12636719",
    build_panel_scrollbar_hover = "#1263674C",
    build_panel_scrollbar_background = "#0b33354C",
    build_panel_title_bar = "#0b3335FF",
    -- Naysayer text color: #d1b897
    code_default = "#d1b897FF",
    -- Naysayer comments: #44b340
    code_comment = "#44b340FF",
    -- Types should be tan like regular text (matching reference)
    code_type = "#d1b897FF",
    code_function = "#d1b897FF",
    code_punctuation = "#d1b897FF",
    code_operation = "#d1b897FF",
    -- Naysayer strings: #2ec09c
    code_string_literal = "#2ec09cFF",
    -- Naysayer constants/numbers: #7ad0c6
    code_value = "#7ad0c6FF",
    code_highlight = "#D89B75FF",
    code_error = "#FF0000FF",
    -- Naysayer keywords: #ffffff
    ...
    indent_guide = "#12636726",
    active_pane_border = "#126367FF",
    ...
    code_comment_highlight4 = "#7ad0c6FF",
    -- Cursor line slightly lighter than main bg
    cursor_line_highlight = "#0e3a3cFF",
    -- Scope background cycle colors - subtle/ghostly, close together
    back_cycle = {
        "#000000", -- Level 1: pure black
        "#080808", -- Level 2: barely visible
        "#101010", -- Level 3: very subtle
        "#181818", -- Level 4
        "#202020", -- Level 5
        "#282828", -- Level 6
        "#303030", -- Level 7
