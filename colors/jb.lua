...
set(0, "IncSearch", { fg = colors.background0, bg = colors.cursor })
set(0, "CurSearch", { fg = colors.background0, bg = colors.cursor })
...
set(0, "FocusRegionHeader", { fg = colors.region_header })
