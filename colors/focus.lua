...
set(0, "DiagnosticVirtualTextError", { fg = colors.ui_error_bright, bold = true })
set(0, "DiagnosticVirtualTextWarn", { fg = colors.ui_warning, bold = true })
set(0, "DiagnosticVirtualTextInfo", { fg = colors.ui_default })
set(0, "DiagnosticVirtualTextHint", { fg = colors.ui_dim })
...
set(0, "TelescopeSelection", { fg = colors.code_default, bg = colors.selection_active, bold = true })
set(0, "TelescopeSelectionCaret", { fg = colors.cursor, bg = colors.selection_active, bold = true })
set(0, "TelescopeMultiSelection", { fg = colors.code_default, bg = colors.list_cursor })
